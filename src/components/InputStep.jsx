          ...
          {mode === 'single' ? (
            <>
              <div className="flex items-center justify-between">
                ...
                <div className="flex rounded-lg overflow-hidden border border-gray-700 text-xs">
                  {[{ id: 'paste', label: 'Paste' }, { id: 'url', label: 'LinkedIn URL' }].map(tab => (
                    <button
                      key={tab.id}
                      type="button"
              ...
              {jobTab === 'url' && (
                <div className="flex-1 min-h-72 flex flex-col gap-4 rounded-xl bg-gray-900 border border-gray-700 p-6">
                  <div>
                    <p className="text-sm text-gray-300 mb-3">Paste the LinkedIn job posting URL</p>
                  ...
                  <div className="mt-auto p-3 rounded-lg bg-gray-800/60 border border-gray-700/50 text-xs text-gray-500">
                    Works with public LinkedIn job postings. If it fails, switch to <strong className="text-gray-300">Paste</strong>.
                  </div>
                </div>
              )}
            </>
            ...
            <>
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-gray-500">One LinkedIn URL per line</span>
              </div>
              <textarea
                value={batchUrls}
